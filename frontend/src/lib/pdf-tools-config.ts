...
export const pdfTools = [
    {
        ...
        title: "PDF Viewer",
        icon: FiEye,
        description: "View and analyze PDF documents with advanced features",
        tools: [
            {
                id: "demo",
                name: "Advanced PDF Viewer",
                description:
                    "View PDFs with text extraction, thumbnails, and more",
            },
        ],
    },
    {
        ...
        tools: [
            ...
            },
            {
                id: "organize",
                name: "Organize Pages",
                description: "Rearrange, delete, or add pages to a PDF",
            },
        ],
    },
    {
        ...
        tools: [
            ...
            },
            {
                ...
                description: "Convert PDF to other file formats",
            },
            {
                id: "ocr",
                name: "OCR",
    ...
    },
    {
        ...
        tools: [
            ...
            },
            {
                id: "sign",
                name: "Sign PDF",
                description: "Add digital signatures to a PDF document",
            },
            {
                id: "redact",
                name: "Redact PDF",
                description:
                    "Permanently remove sensitive information from a PDF",
            },
        ],
    },
    {
